...
const Orders = () => {
  ...
  const [ratingsSort, setRatingsSort] = useState<"newest" | "oldest" | "highest" | "lowest">(
    "newest",
  );
        ...
        {ratings.length > 0 &&
          (() => {
            ...
            const sorted = [...filtered].sort((a, b) => {
              if (ratingsSort === "newest")
                return +new Date(b.created_at) - +new Date(a.created_at);
              if (ratingsSort === "oldest")
                ...
                >
                  ...
                  <div className={`flex items-center gap-2 px-4 py-3 ${sc.bg}`}>
                    ...
                    <span
                      ...
                      className={`text-sm font-bold ${sc.color}`}
                    >
                      {sc.label}
                    </span>
                        ...
                        {statusSteps.map((step, i) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <span
                                className={`mt-0.5 text-[8px] text-center leading-tight ${
                                  isCurrent
                  ...
                  <div className="p-4">
                            ...
                            >
                              ...
                              <div className="min-w-0">
                                ...
                                <p className="mt-0.5 text-xs text-foreground">
                                  We couldn't find a driver{areaSuffix} right now. We're still
                                  trying — you'll be notified as soon as a driver accepts your
                                  order.
                                </p>
                              </div>
                            </div>
                        ...
                        <div className="mt-3 rounded-xl border border-primary/30 bg-primary/5 p-3">
                          ...
                          <p className="mt-0.5 text-xs text-muted-foreground">
                            ...
                            <span className="font-bold text-primary">
                              {storeInfo.currency}
                              {Number(order.refund_amount || order.total).toFixed(2)}
                            </span>
                          </p>
                          <div className="mt-3 grid grid-cols-1 gap-2 sm:grid-cols-2">
                            <button
                              onClick={() =>
                                handleChooseRefund(order.id, order.order_number, "credits")
                              }
                            ...
                            <button
                              onClick={() =>
                                handleChooseRefund(order.id, order.order_number, "bank")
                              }
                          ...
                          <p className="mt-2 text-[10px] text-muted-foreground">
                            ⚠️ Bank refunds take{" "}
                            <span className="font-semibold">3–5 business days</span> to reflect.
                    ...
                    {isCancelled && order.refund_status === "bank_pending" && (
                      <div className="mt-3 flex items-center gap-2 rounded-xl border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-700">
                        <Clock className="h-4 w-4" />
                        <span className="font-semibold">
                          Bank refund of R{Number(order.refund_amount || 0).toFixed(2)} pending —
                          3–5 business days
                        </span>
                      </div>
                    )}
